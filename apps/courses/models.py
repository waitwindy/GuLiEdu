...
class CourseInfo(models.Model):
    ...
    level = models.CharField(choices=(('gj',"高级"),('zj',"中级"),('cj',"初级")),max_length=5,verbose_name="学习难度",default='cj')
...
class VideoInfo(models.Model):
    ...
    url = models.URLField(default="www.atguigu.com",verbose_name="视频连接",max_length=200)
